## Evaluating Real Datasets using Baseline algos CMTL , BatchOpt
...
def BatchOpt(W):    
    return np.real(sqrtm(np.transpose(W) @ W) / np.trace(sqrtm(np.transpose(W) @ W)))
